...
$room_query = "SELECT * FROM rooms_status RS INNER JOIN rooms R ON RS.room_id = R.id WHERE RS.status='$room_availability' AND R.Id='$room_name'";
echo $room_query;
...
if(mysqli_num_rows($room_result) > 0) {
    ...
    $html .= '
        <tr>
            <td class="tg-lboi" colspan="15">No Data Available</td>
        </tr>
    ';
