...
$list_of_rooms_query = "SELECT rooms.type, rooms.capacity, rooms.image, rooms.inclusions, rooms.peak_rate, rooms.off_peak_rate, room_id, count('room_id') as room_count 
